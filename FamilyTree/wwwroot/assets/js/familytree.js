var FamilyTree = function (e, t) {
    ...
    (this._event_id = FamilyTree._guid()),
        ...
        ((this._vScroll = {}),
            ...
            this.config.nodeMenuUI ? (this.nodeMenuUI = this.config.nodeMenuUI) : (this.nodeMenuUI = new FamilyTree.menuUI()),
            this.nodeMenuUI.init(this, this.config.nodeMenu),
            this.config.nodeCircleMenuUI ? (this.nodeCircleMenuUI = this.config.nodeCircleMenuUI) : (this.nodeCircleMenuUI = new FamilyTree.circleMenuUI()),
            this.nodeCircleMenuUI.init(this, this.config.nodeCircleMenu),
            this.config.nodeContextMenuUI ? (this.nodeContextMenuUI = this.config.nodeContextMenuUI) : (this.nodeContextMenuUI = new FamilyTree.menuUI()),
            this.nodeContextMenuUI.init(this, this.config.nodeContextMenu),
            this.config.toolbarUI ? (this.toolbarUI = this.config.toolbarUI) : (this.toolbarUI = new FamilyTree.toolbarUI()),
            this.config.notifierUI ? (this.notifierUI = this.config.notifierUI) : (this.notifierUI = new FamilyTree.notifierUI()),
            ...
            FamilyTree._intersectionObserver(this.element, function (e) {
                (i.isVisible = e),
                    ...
                    i.isVisible &&
                    (i._loaded ? i._draw(!1, FamilyTree.action.update) : (i._setInitialSizeIfNotSet(), i._draw(!1, FamilyTree.action.init)));
            }));
};
(FamilyTree._defaultConfig = function (e) {
    return {
        ...
        editForm: {
            ...
            focusBinding: null,
            buttons: {
                edit: { icon: FamilyTree.icon.edit(24, 24, "#fff"), text: "Edit", hideIfEditMode: !0, hideIfDetailsMode: !1 },
                    ...
                    function (e) {
                        if (!a.notifierUI.show(e.notif)) {
                            ...
                            if ((FamilyTree.events.publish("render", [a, n]), (l = n.content), (e = n.res), (l += a.ui.lonely(a.config)), t !== FamilyTree.action.exporting)) {
                                (t !== FamilyTree.action.centerNode && t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update) || (d = s),
                                ...
                                t === FamilyTree.action.centerNode
                                    ...
                                    : !s ||
                                        !a.response ||
                                        (s[0] == a.response.viewBox[0] && s[1] == a.response.viewBox[1] && s[2] == a.response.viewBox[2] && s[3] == a.response.viewBox[3]) ||
                                        (t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update && t !== FamilyTree.action.init)
                                        ? 0 == y[0].length && (u || (r && r(), FamilyTree.events.publish("redraw", [a]), (u = !0)))
                                        : FamilyTree.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function () {
                                            a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), u || (r && r(), FamilyTree.events.publish("redraw", [a]), (u = !0));
                                        }),
                                    a._initialized || ((a._initialized = !0), a.filterUI.update(), FamilyTree.events.publish("init", [a])),
        ...
        if (null != r) {
            ...
            if (null != a) {
                ...
                FamilyTree.events.publish("ripple", [this, b]),
                    ...
                    f.appendChild(g),
                    a.appendChild(f),
                    FamilyTree.animate(g, { r: 0, opacity: 1 }, { r: h, opacity: 0 }, 500, FamilyTree.anim.outPow, function () {
                        a.removeChild(f);
                    });
            }
        }
    ...
    (FamilyTree.prototype.search = function (e, t, i) {
        return (
            ...
            FamilyTree._search.search(this.config.nodes, e, t, i, this.config.searchDisplayField, this.config.searchFieldsWeight, this.searchUI._searchFieldsAbbreviation)
        );
    }),
    ...
    (FamilyTree._defaultConfig = function (e) {
        ...
        return (
            ...
            e && e.template
                ? ((t.tags.male = { template: e.template + "_male" }), (t.tags.female = { template: e.template + "_female" }))
                : ((t.tags.male = { template: t.template + "_male" }), (t.tags.female = { template: t.template + "_female" })),
            t
        );
    }),
    ...
    (FamilyTree.prototype.remove = function (e) {
        ...
        if (t)
            for (var i = this.config.nodes.length - 1; i >= 0; i--)
                (this.config.nodes[i].pid != e && this.config.nodes[i].stpid != e) || ((this.config.nodes[i].pid = t.pid), (this.config.nodes[i].stpid = t.stpid)), this.config.nodes[i].id == e && this.config.nodes.splice(i, 1);
        return this;
    }),
    ...
    (FamilyTree.prototype.get = function (e) {
        for (var t = 0; t < this.config.nodes.length; t++) if (this.config.nodes[t].id == e) return JSON.parse(JSON.stringify(this.config.nodes[t]));
        return null;
    }),
        ...
        if (FamilyTree.isNEU(t)) console.error("addPartnerAndParentNodes invalid data");
            ...
            if (FamilyTree.isNEU(o.mid) || FamilyTree.isNEU(o.fid)) {
                ...
                Array.isArray(i.pids) &&
                    (1 != i.pids.length && console.error("addChildAndPartnerNodes partnerData.pids has to have one partner"), (s = this.get(i.pids[0])), Array.isArray(s.pids) || (s.pids = []), s.pids.push(i.id), l.push(s));
                var d = { addNodesData: [i], updateNodesData: l, removeNodeId: null };
                if (!1 !== this._fireUpdate_addUpdateRemove(d, a)) {
                    ...
                    s ? (m = s.id) : FamilyTree.isNEU(o.pid) ? (FamilyTree.isNEU(o.mid) ? FamilyTree.isNEU(o.fid) || (m = o.fid) : (m = o.mid)) : (m = o.pid),
                        n._draw(!1, FamilyTree.action.update, { id: m }, function () {
                ...
                if (FamilyTree.isNEU(e)) console.error("addParentNode invalid childId");
                    ...
                    if (!1 !== this._fireUpdate_addUpdateRemove(d, a)) {
                        ...
                        (this.config.roots = [d.addNodesData[0].id]),
                            this._draw(!1, FamilyTree.action.insert, { id: c, insertedNodeId: d.addNodesData[0].id }, function () {
    ...
    (FamilyTree.prototype.canRemove = function (e) {
        ...
        return !((!i && !r) || a || l) || !(i || r || a || o || !l || n) || !(i || r || !a || !n) || !(i || r || a || !n);
    }),
    (FamilyTree.prototype.removeNode = function (e, t, i) {
        var r = this;
        if (this.canRemove(e)) {
    ...
    (FamilyTree.anim.inOutExp = function (e) {
        return e < 0 ? 0 : e > 1 ? 1 : e < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * e - 1)) : 0.5 * (2 - Math.pow(2, 10 * (-2 * e + 1)));
    }),
    ...
    (FamilyTree.anim.inOutCirc = function (e) {
        return e < 0 ? 0 : e > 1 ? 1 : e < 1 ? -0.5 * (Math.sqrt(1 - e * e) - 1) : 0.5 * (Math.sqrt(1 - (2 * e - 2) * (2 * e - 2)) + 1);
    }),
    ...
    (FamilyTree.anim.inOutBack = function (e) {
        return e < 0 ? 0 : e > 1 ? 1 : e < 0.5 ? 4 * e * e * (7.1898 * e - 2.5949) * 0.5 : 0.5 * ((2 * e - 2) * (2 * e - 2) * (3.5949 * (2 * e - 2) + 2.5949) + 2);
    }),
    ...
    (FamilyTree.prototype._attachEventHandlers = function (e) {
        if (this.config.interactive) {
            ...
            this.config.enableTouch || FamilyTree.isMobile()
                ? (this._addEvent(e, "touchstart", this._globalMouseDownHandler), this._addEvent(e, "touchend", this._globalClickHandler))
                : (this._addEvent(e, "mousedown", this._globalMouseDownHandler),
                    ...
                    (this.config.mouseScrool != FamilyTree.action.zoom && this.config.mouseScrool != FamilyTree.action.ctrlZoom) ||
                    (this._addEvent(e, "DOMMouseScroll", this._mouseScrollHandler), this._addEvent(e, "mousewheel", this._mouseScrollHandler)));
    ...
    (FamilyTree._intersects = function (e, t, i) {
        ...
        var o,
            ...
            p = t.r,
            h = t.s;
        return 0 !== (o = (n - r) * (h - m) - (p - c) * (l - a)) && ((s = ((a - l) * (p - r) + (n - r) * (h - a)) / o), 0 < (d = ((h - m) * (p - r) + (c - p) * (h - a)) / o) && d < 1 && 0 < s && s < 1);
    }),
    ...
    (FamilyTree._addPointTop = function (e, t, i, r, a) {
        ...
        return (
            "left" == a
                ? (n = e.leftNeighbor ? e.x + (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2 : e.x - i.siblingSeparation / 2)
                : "right" == a && (n = e.rightNeighbor ? e.x + e.w + (e.rightNeighbor.x - (e.x + e.w)) / 2 : e.x + e.w + i.siblingSeparation / 2),
    ...
    (FamilyTree._addPointLeft = function (e, t, i, r, a) {
        var n,
            l = t[t.length - 1][0];
        "bottom" == a
            ? (n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2)
            : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2),
    ...
    (FamilyTree.editUI.prototype.show = function (e, t, i) {
        ...
        this.obj.element.appendChild(a.element),
            ...
            i
                ...
                : (this.interval = FamilyTree.animate(a.element, { right: -20, opacity: 0 }, { right: 0, opacity: 1 }, 300, FamilyTree.anim.outSin, function () {
        ...
        for (var n = this.obj.element.querySelectorAll("[bft-input-btn]"), l = 0; l < n.length; l++) {
            n[l].addEventListener("click", function (t) {
                t.preventDefault(), FamilyTree.events.publish("element-btn-click", [r, { input: this.parentNode.querySelector("input"), nodeId: e, event: t }]);
            });
        }
        this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", function (e) {
            e.stopPropagation(), e.preventDefault();
            var t = this,
                i = FamilyTree.elements.textbox({}, { type: "textbox", label: r.obj.config.editForm.addMoreFieldName, btn: r.obj.config.editForm.addMoreBtn }, "280px");
    ...
    (FamilyTree.editUI.prototype._focusElement = function (e) {
        var t = null;
        FamilyTree.isNEU(this.obj.config.editForm.focusBinding) ? FamilyTree.isNEU(e) || (t = document.getElementById(e)) : (t = this.obj.element.querySelector('[data-binding="' + this.obj.config.editForm.focusBinding + '"]')),
    ...
    (FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
        ...
        FamilyTree.isNEU(g) && (g = ""), (T = FamilyTree.isNEU(T) ? FamilyTree.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${T}"></img>`);
        var w = !t,
            k = t ? "display:none;" : "",
            S = t || !s ? "display:none;" : "",
        ...
        return (
            (I.innerHTML = `<div>\n                        <div class="bft-edit-form-header" ${C}>\n                            ${N}\n                            <h1 class="bft-edit-form-title">${FamilyTree._escapeGreaterLessSign(
                ...
                for (var i in m) {
                    var r = m[i];
                    FamilyTree.isNEU(r) || (w && r.hideIfEditMode) || (t && r.hideIfDetailsMode) || (l && "Edit" == r.text) || (e += `<div data-edit-from-btn='${i}' class="bft-img-button" ${C} title="${r.text}">${r.icon}</div>`);
                }
                return e;
                ...
                for (var e = "", i = 0; i < o.length; i++) {
                    ...
                    if (Array.isArray(r)) {
                        ...
                        for (var a = 0; a < r.length; a++) {
                            ...
                            !FamilyTree.isNEU(s.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s.value) && (n = s.id), FamilyTree.isNEU(s.value) || A.push(`${l.label}: ${s.value}`), (e += s.html);
                        }
                        e += "</div>";
                    } else {
                        s = FamilyTree.elements[r.type](u, r, "280px", t);
                        !FamilyTree.isNEU(s.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s.value) && (n = s.id), FamilyTree.isNEU(s.value) || A.push(`${r.label}: ${s.value}`), (e += s.html);
                    }
                }
                return e;
    ...
    (FamilyTree.menuUI.prototype._show = function (e, t, i, r, a) {
        ...
        for (var s in (a = o.menu)) {
            ...
            if (s == 'father' && motherItem !== undefined) {
                let fatherDiv = '';
                let icon = fatherItem.icon;
                let text = fatherItem.text;
                void 0 === icon && (icon = FamilyTree.icon['father'] ? FamilyTree.icon['father'](24, 24, "#7A7A7A") : ""),
                    "function" == typeof text && (text = text()),
                    "function" == typeof icon && (icon = icon()),
                    (fatherDiv = "<div " + FamilyTree.attr.item + '="' + s + '">' + icon + "<span>&nbsp;&nbsp;" + text + "</span></div>");

                let motherDiv = '';
                icon = motherItem.icon;
                text = motherItem.text;
                void 0 === icon && (icon = FamilyTree.icon['mother'] ? FamilyTree.icon['mother'](24, 24, "#7A7A7A") : ""),
                    "function" == typeof text && (text = text()),
                    "function" == typeof icon && (icon = icon()),
                    (motherDiv = "<div " + FamilyTree.attr.item + '="mother">' + icon + "<span>&nbsp;&nbsp;" + text + "&nbsp;&nbsp;&nbsp;</span></div>");
                let menuItem = '<div style="display:flex">' + fatherDiv + motherDiv + '</div>';
                l += menuItem;
            }

            else if (s == 'wife' && husbandItem !== undefined) {
                let wifeDiv = '';
                let icon = wifeItem.icon;
                let text = wifeItem.text;
                void 0 === icon && (icon = FamilyTree.icon['wife'] ? FamilyTree.icon['wife'](24, 24, "#7A7A7A") : ""),
                    "function" == typeof text && (text = text()),
                    "function" == typeof icon && (icon = icon()),
                    (wifeDiv = "<div " + FamilyTree.attr.item + '="' + s + '">' + icon + "<span>&nbsp;&nbsp;" + text + "</span></div>");

                let husbandDiv = '';
                icon = husbandItem.icon;
                text = husbandItem.text;
                void 0 === icon && (icon = FamilyTree.icon['husband'] ? FamilyTree.icon['husband'](24, 24, "#7A7A7A") : ""),
                    "function" == typeof text && (text = text()),
                    "function" == typeof icon && (icon = icon()),
                    (husbandDiv = "<div " + FamilyTree.attr.item + '="husband">' + icon + "<span>&nbsp;&nbsp;" + text + "</span></div>");
                let menuItem = '<div style="display:flex">' + wifeDiv + husbandDiv + '</div>';
                l += menuItem;
            }

            else if (s == 'son' && daughterItem !== undefined) {
                let sonDiv = '';
                let icon = sonItem.icon;
                let text = sonItem.text;
                void 0 === icon && (icon = FamilyTree.icon['son'] ? FamilyTree.icon['son'](24, 24, "#7A7A7A") : ""),
                    "function" == typeof text && (text = text()),
                    "function" == typeof icon && (icon = icon()),
                    (sonDiv = "<div " + FamilyTree.attr.item + '="' + s + '">' + icon + "<span>&nbsp;&nbsp;" + text + "&nbsp;&nbsp;&nbsp;&nbsp;</span></div>");

                let daughterDiv = '';
                icon = daughterItem.icon;
                text = daughterItem.text;
                void 0 === icon && (icon = FamilyTree.icon['daughter'] ? FamilyTree.icon['daughter'](24, 24, "#7A7A7A") : ""),
                    "function" == typeof text && (text = text()),
                    "function" == typeof icon && (icon = icon()),
                    (daughterDiv = "<div " + FamilyTree.attr.item + '="daughter">' + icon + "<span>&nbsp;&nbsp;" + text + "</span></div>");
                let menuItem = '<div style="display:flex">' + sonDiv + daughterDiv + '</div>';
                l += menuItem;
            }
        ...
        if ("" != l) {
            ...
            FamilyTree.animate(this.wrapper, { opacity: 0, left: p - this.wrapper.offsetWidth }, { opacity: 1, left: h }, 300, FamilyTree.anim.inOutPow);
    ...
    (FamilyTree.circleMenuUI.prototype._show = function (e, t) {
        ...
        if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
            ...
            if (FamilyTree.isNEU(h) || h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
                ...
                for (var y = 0, g = Object.keys(f.menu).length, T = 2 * a.nodeCircleMenuButton.radius + 4, b = 2 * Math.PI * T, v = b / g - (2 * a.nodeCircleMenuButton.radius + 2); v < 0;)
                    (T += 8), (v = (b = 2 * Math.PI * T) / g - (2 * a.nodeCircleMenuButton.radius + 2));
                for (var F in ((h = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id, e),
                    ...
                    this._buttonsInterval.push(
                        FamilyTree.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, M, L] }, 250, FamilyTree.anim.outBack, function (e) {
                            ...
                            e[0].addEventListener("mouseenter", function (e) {
                                FamilyTree.events.publish("mouseenter", [i, { from: r, menuItem: f.menu[t], menuItemName: t, event: e }]);
                            }),
                                e[0].addEventListener("mouseout", function (e) {
                                    FamilyTree.events.publish("mouseout", [i, { from: r, menuItem: f.menu[t], menuItemName: t, event: e }]);
                                });
                        })
                    );
                }
                this._linesInterval.push(FamilyTree.animate(p[0], { x1: -a.nodeCircleMenuButton.radius / 2, y1: -6, x2: a.nodeCircleMenuButton.radius / 2, y2: -6 }, { x1: -7, y1: -7, x2: 7, y2: 7 }, 500, FamilyTree.anim.inOutSin)),
                    this._linesInterval.push(FamilyTree.animate(p[1], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 0, x2: a.nodeCircleMenuButton.radius / 2, y2: 0 }, { x1: 0, y1: 0, x2: 0, y2: 0 }, 500, FamilyTree.anim.inOutSin)),
                    this._linesInterval.push(FamilyTree.animate(p[2], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 6, x2: a.nodeCircleMenuButton.radius / 2, y2: 6 }, { x1: -7, y1: 7, x2: 7, y2: -7 }, 500, FamilyTree.anim.inOutSin));
            } else this.hide();
        }
    }),
    ...
    (FamilyTree.toolbarUI.prototype.init = function (e, t) {
        if (t) {
            (this.obj = e),
                ...
                Object.assign(this.div.style, { position: "absolute", padding: "3px", right: this.obj.config.padding - 10 + "px", bottom: this.obj.config.padding - 10 + "px" }),
                ...
                t.zoom &&
                ((this.div.innerHTML += "<div " + FamilyTree.attr.tlbr + '="plus">' + FamilyTree.toolbarUI.zoomInIcon + "</div>"),
                    (this.div.innerHTML += "<div " + FamilyTree.attr.tlbr + '="minus">' + FamilyTree.toolbarUI.zoomOutIcon + "</div>")),
                t.layout &&
                ((this.div.innerHTML += "<div " + FamilyTree.attr.tlbr + '="layout">' + FamilyTree.toolbarUI.layoutIcon + "</div>"),
                ...
                t.fullScreen && (this.div.innerHTML += "<div " + FamilyTree.attr.tlbr + '="fullScreen">' + FamilyTree.toolbarUI.openFullScreenIcon + "</div>"),
    ...
    (FamilyTree.toolbarUI.prototype.showLayout = function () {
        (this._visible = !0),
            ...
            FamilyTree.animate(this.div, { bottom: this.obj.config.padding - 10 }, { bottom: this.obj.config.padding + 135 }, this.obj.config.anim.duration, this.obj.config.anim.func),
            FamilyTree.animate(this.layouts, { bottom: -145 }, { bottom: 0 }, this.obj.config.anim.duration, this.obj.config.anim.func);
    }),
    (FamilyTree.toolbarUI.prototype.hideLayout = function () {
        (this._visible = !1),
            ...
            FamilyTree.animate(this.div, { bottom: this.obj.config.padding + 135 }, { bottom: this.obj.config.padding - 10 }, this.obj.config.anim.duration, this.obj.config.anim.func),
            FamilyTree.animate(this.layouts, { bottom: 0 }, { bottom: -145 }, this.obj.config.anim.duration, this.obj.config.anim.func);
    }),
    ...
    (FamilyTree.notifierUI.prototype.show = function (e, t) {
        ...
        var n = i.offsetWidth;
        return (i.style.width = "20px"), FamilyTree.animate(i, { opacity: 0, width: 10 }, { opacity: 1, width: n }, this.obj.config.anim.duration, this.obj.config.anim.func), !0;
    }),
    void 0 === FamilyTree && (FamilyTree = {}),
        ...
        (n.className = "bft-ripple-container"),
            e.addEventListener("mousedown", function (t) {
                ...
                return (
                    ...
                    (n = "top:" + (t.pageY - i.top - a / 2) + "px; left: " + l + "px; height: " + a + "px; width: " + a + "px;"),
    ...
    (FamilyTree._getClientXY = function (e) {
        return -1 == e.type.indexOf("touch") ? { x: e.clientX, y: e.clientY } : e.changedTouches.length ? { x: e.changedTouches[0].clientX, y: e.changedTouches[0].clientY } : void 0;
    }),
    (FamilyTree._getClientTouchesXY = function (e, t) {
        return -1 != e.type.indexOf("touch") ? (e.touches.length < t + 1 ? { x: null, y: null } : { x: e.touches[t].clientX, y: e.touches[t].clientY }) : { x: e.clientX, y: e.clientY };
    }),
    ...
    (FamilyTree._menuPosition = function (e, t, i) {
        var r = e.getBoundingClientRect(),
            ...
            l = r.left - a.left,
            o = r.top - a.top;
        return r.top + n.height > a.top + a.height && (o -= n.height), r.left - n.width < a.left && (l += n.width), { x: l, y: o };
    }),
    ...
    (FamilyTree.wrapText = function (e, t) {
        ...
        if (-1 != m.indexOf("multiline")) {
            ...
            b.setAttributeNS(null, "x", o), b.setAttributeNS(null, "y", s), b.setAttributeNS(null, "text-anchor", d), b.appendChild(v), h.appendChild(b);
            y = 1;
    ...
    (FamilyTree._downloadFile = function (e, t, i, r, a) {
        ...
        if (1 == r) {
            ...
            if (void 0 !== o.download) {
                ...
                var s = i;
                s.toLowerCase().endsWith(a.toLowerCase()) || (s = s + "." + a), o.setAttribute("download", s), (o.style.visibility = "hidden"), document.body.appendChild(o), o.click(), document.body.removeChild(o);
            }
        }
    }),
    ...
    (FamilyTree._csvToArray = function (e, t) {
        ...
        for (var i = new RegExp("(\\" + t + '|\\r?\\n|\\r|^)(?:"([^"]*(?:""[^"]*)*)"|([^"\\' + t + "\\r\\n]*))", "gi"), r = [[]], a = null; (a = i.exec(e));) {
            var n,
                l = a[1];
            l.length && l !== t && r.push([]), (n = a[2] ? a[2].replace(new RegExp('""', "g"), '"') : a[3]), r[r.length - 1].push(n);
        }
        return r;
    }),
    ...
    (FamilyTree.accentFold = function (e) {
        return (e = e.toString().toLowerCase()).replace(/([àáâãäå])|([ç])|([èéêë])|([ìíîï])|([ñ])|([òóôõöø])|([ß])|([ùúûü])|([ÿ])|([æ])/g, function (e, t, i, r, a, n, l, o, s, d, c) {
            return t ? "a" : i ? "c" : r ? "e" : a ? "i" : n ? "n" : l ? "o" : o ? "s" : s ? "u" : d ? "y" : c ? "ae" : void 0;
        });
    }),
    ...
    (FamilyTree.prototype._defaultExportOptions = function (e, t) {
        return (
            null == e && (e = {}),
            "svg" == t ? ((e.ext = "svg"), (e.mime = "image/svg+xml")) : "pdf" == t ? ((e.mime = "application/pdf"), (e.ext = "pdf")) : "png" == t && ((e.mime = "image/png"), (e.ext = "png")),
            ...
            "pdf" == t && null == e.footer ? (e.footer = "Page {current-page} of {total-pages}") : null == e.footer && (e.footer = ""),
        ...
        e.margin && e.margin[0] < 2 && (e.margin[0] = 2),
            ...
            this._draw(!1, FamilyTree.action.exporting, r, function (r) {
                ...
                if (((a.innerHTML = r), e.padding > 0)) {
                    ...
                    (l[0] -= e.padding), (l[1] -= e.padding), (l[2] += 2 * e.padding), (l[3] += 2 * e.padding), n.setAttribute("viewBox", l.join()), n.setAttribute("width", l[2]), n.setAttribute("height", l[3]);
                }
                if ("svg" == e.ext)
                    if (t) t(e, a.innerHTML);
                        ...
                        FamilyTree._downloadFile(e.mime, o.content, o.options.filename, o.options.openInNewTab, o.options.ext);
                    }
                else
    ...
    (FamilyTree.prototype._pagesA100 = function (e, t, i) {
        ...
        var l = r[0],
            ...
            s = r[2],
            d = r[3],
            c = { w: e.landscape ? n - (e.margin[1] + e.margin[3]) : a - (e.margin[1] + e.margin[3]), h: e.landscape ? a - (e.margin[0] + e.margin[2]) : n - (e.margin[0] + e.margin[2]) },
    ...
    (FamilyTree.prototype._exportProfile = function (e, t) {
        ...
        var n = { w: e.landscape ? a - (e.margin[1] + e.margin[3]) : r - (e.margin[1] + e.margin[3]), h: e.landscape ? r - (e.margin[0] + e.margin[2]) : a - (e.margin[0] + e.margin[2]) },
    ...
    (FamilyTree._importSetColumnNames = function (e, t) {
        if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
            ...
            (T.id = "pid-select"), (T.style.fontSize = "16px"), (T.style.color = "rgb(122, 122, 122)"), (T.style.padding = "5px"), (T.style.margin = "5px"), (T.style.width = "60%"), (T.style.border = "1px solid #aeaeae"), i.appendChild(T);
    ...
    (FamilyTree.prototype._globalMouseDownHandler = function (e, t) {
        ...
        if (
            (-1 != t.type.indexOf("touch") && (1 == t.touches.length ? (this._touch = { x: t.touches[0].clientX, y: t.touches[0].clientY }) : (this._touch = null), (i = { move: "touchmove", up: "touchend", touchstart: "touchstart" })),
                e == t.target)
        )
    ...
    (FamilyTree.prototype._globalClickHandler = function (e, t) {
        ...
        for (var o = t.target; o != e;) {
            ...
            if (o.hasAttribute(FamilyTree.attr.control_node_circle_menu_name)) return t.stopPropagation(), t.preventDefault(), void this._nodeCircleMenuItemClickHandler(o, t);
            ...
            if (o.hasAttribute(FamilyTree.attr.c_link_from)) return void FamilyTree.events.publish("clink-click", [this, { from: o.getAttribute(FamilyTree.attr.c_link_from), to: o.getAttribute(FamilyTree.attr.c_link_to), event: t }]);
            if (o.hasAttribute(FamilyTree.attr.s_link_from)) return void FamilyTree.events.publish("slink-click", [this, { from: o.getAttribute(FamilyTree.attr.s_link_from), to: o.getAttribute(FamilyTree.attr.s_link_to), event: t }]);
            o = o.parentNode;
        }
    }),
        ...
        if (this.config.mouseScrool != FamilyTree.action.ctrlZoom || t.ctrlKey) {
            ...
            void 0 === c && (c = -t.detail),
                ...
                (function e() {
                    r = !0;
                    var t = (l - o) / n;
                    t > 0 ? t++ : t--, (o += t), i.zoom(1 - t / 12 / 50, s), parseInt(o) == parseInt(l) ? (r = !1) : d(e);
                })();
        }
    }),
        ...
        if (n.draggable) {
            ...
            var b = function (e, t) {
                ...
                v = function (t) {
                    if (h) {
                        var i = FamilyTree._getClientXY(t),
                            r = t.target;
                        FamilyTree.isMobile() && (r = document.elementFromPoint(i.x, i.y)), (i.x += T.x * d), (i.y += T.y * d);
                        var o = FamilyTree._getOffsetXY(l.element, t),
                            s = { left: l.width() - (o.x + l.config.padding) < 0, right: o.x - l.config.padding < 0, down: l.height() - (o.y + l.config.padding) < 0, up: o.y - l.config.padding < 0 };
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            for (
                                l.stopMove(),
                                p.classList && (p.classList.add("bft-cursor-grab"), p.classList.remove("bft-cursor-move"), p.classList.remove("bft-cursor-nodrop"), p.classList.remove("bft-cursor-copy")),
                                b(c, m),
                                c = null,
                                m = null;
                                null != r && r != p;
                            ...
                            if (null != c) {
                                ...
                                for (var I = l.getNode(c), A = FamilyTree.getStParentNodes(I), N = 0; N < A.length; N++) {
                                    var E = l.getNodeElement(A[N].id);
                            ...
                            var M = (i.x - h.x) / d,
                                L = (i.y - h.y) / d;
                            if (((u[4] = y + M), (u[5] = g + L), !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                                !1 === FamilyTree.events.publish("drag", [l.nodeCircleMenuUI, { from: C, menuItem: n, menuItemName: a }]) && F(), (e._dragEventFired = !0);
                            f.setAttribute("transform", "matrix(" + u.toString() + ")");
                        }
                    }
                },
                F = function (t) {
                    if (
                        (l.stopMove(),
                            p.classList && (p.classList.remove("bft-cursor-grab"), p.classList.remove("bft-cursor-move"), p.classList.remove("bft-cursor-nodrop"), p.classList.remove("bft-cursor-copy")),
                            p.removeEventListener(i.move, v),
                            p.removeEventListener(i.up, F),
                            i.leave && p.removeEventListener(i.leave, F),
                            s.id == c || null == c)
                    )
                        return p.removeChild(f), (l._gragStartedId = null), void (e._dragEventFired && FamilyTree.events.publish("drop", [l.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n }]));
                    var r = l.getNode(c);
                    FamilyTree.events.publish("drop", [l.nodeCircleMenuUI, { from: s.id, to: r.id, menuItem: n, menuItemName: a }]), b(c, m), p.removeChild(f), (l._gragStartedId = null);
                };
        ...
        if (this.config.enableDragDrop) {
            ...
            var y = function (e, t) {
                ...
                g = function (t) {
                    if (c) {
                        ...
                        var a = FamilyTree._getOffsetXY(s.element, t),
                            g = { left: s.width() - (a.x + s.config.padding) < 0, right: a.x - s.config.padding < 0, down: s.height() - (a.y + s.config.padding) < 0, up: a.y - s.config.padding < 0 };
                        if (g.left || g.right || g.up || g.down) {
                            ...
                            if (
                                (s.stopMove(),
                                    d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")),
                                    y(l, o),
                                    (l = null),
                                    (o = null),
                            ...
                            if (null != l) {
                                ...
                                for (var S = s.getNode(l), C = FamilyTree.getStParentNodes(S), I = 0; I < C.length; I++) {
                                    var A = s.getNodeElement(C[I].id);
                                    A && (A.style.opacity = 0.1);
                                }
                                !s.canUpdateLink(n.id, l) && d.classList
                                    ? (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-copy"), d.classList.add("bft-cursor-nodrop"))
                                    : d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.add("bft-cursor-copy"), d.classList.remove("bft-cursor-nodrop"));
                            }
                            var N = (i.x - c.x) / f,
                                E = (i.y - c.y) / f;
                            if (((m[4] = p + N), (m[5] = h + E), !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                ...
                T = function (t) {
                    if (
                        (s.stopMove(),
                            d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")),
                            d.removeEventListener(i.move, g),
                            d.removeEventListener(i.up, T),
                            i.leave && d.removeEventListener(i.leave, T),
                            n.id == l || null == l)
                    )
                        return d.removeChild(u), (s._gragStartedId = null), void (e._dragEventFired && FamilyTree.events.publish("drop", [s, n.id]));
                    var r = s.getNode(l);
        ...
        if (e) {
            if (((this._movePosition = e), !this._moveInterval)) {
                ...
                this._moveInterval = setInterval(function () {
                    ...
                    i._movePosition.left && (n++, (e.x = (n * FamilyTree.MOVE_STEP) / a), (e.xWithoutScale = n * FamilyTree.MOVE_STEP)),
                        i._movePosition.right && (n++, (e.x = (-n * FamilyTree.MOVE_STEP) / a), (e.xWithoutScale = -n * FamilyTree.MOVE_STEP)),
                        i._movePosition.up && (l++, (e.y = (-l * FamilyTree.MOVE_STEP) / a), (e.yWithoutScale = -l * FamilyTree.MOVE_STEP)),
                        i._movePosition.down && (l++, (e.y = (l * FamilyTree.MOVE_STEP) / a), (e.yWithoutScale = l * FamilyTree.MOVE_STEP)),
    ...
    (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
        ...
        t.touches && t.touches.length > 1 && ((s.type = "pinch"), (s.dist = Math.sqrt((l.x - o.x) * (l.x - o.x) + (l.y - o.y) * (l.y - o.y)))), "pan" == s.type && (this._hideBeforeAnimation(), this._changeCursorOnPanStart(a, n, t));
        var d = function (e) {
        ...
        e.addEventListener(i.move, d), e.addEventListener(i.up, c), i.leave && e.addEventListener(i.leave, c), i.touchstart && e.addEventListener(i.touchstart, c);
    }),
    (FamilyTree.prototype._changeCursorOnPanStart = function (e, t, i) {
        ...
        (r.style.display = "inherit"),
            ...
            FamilyTree.animate(r, { transform: [0, 0, 0, 0, n, l], opacity: 0 }, { transform: [1 / t, 0, 0, 1 / t, n, l], opacity: 1 }, 300, FamilyTree.anim.outBack);
    }),
    ...
    (FamilyTree.searchUI.prototype.init = function (e) {
        ...
        (o.innerHTML += s.html), (this.xBtn = o.querySelector("[bft-input-btn]")), (this.xBtn.style.display = "none"), (this.searchTableWrapper = document.createElement("div")), o.appendChild(this.searchTableWrapper);
        ...
        var c = function () {
            ...
            m = function () {
                ...
                null == i && e.length > 0
                    ...
                    : e.length > 0 && i.previousSibling && i.previousSibling.setAttribute && (i.removeAttribute("data-selected"), i.previousSibling.setAttribute("data-selected", "yes"));
            };
    }),
    (FamilyTree.searchUI.prototype._enterHandler = function () {
        ...
        if (e) {
            if (e.hasAttribute("data-search-item-id")) {
                ...
                if (this.input.value != FamilyTree.SEARCH_HELP_SYMBOL) 0 != FamilyTree.events.publish("searchclick", [that.obj, t]) && this.obj.center(t);
                else (this.input.value = t + " "), (this.searchTableWrapper.innerHTML = "");
            }
        } else (this._searchAfterEnterPress = !0), this.__search(), (this.searchTableWrapper.innerHTML = ""), this.obj.draw();
    }),
    (FamilyTree.searchUI.prototype._initSearchFields = function () {
        ...
        if (null == this.obj.config.searchFieldsAbbreviation) {
            ...
            for (e = 0; e < this._searchFields.length; e++) {
                for (var i = this._searchFields[e], r = 0, a = i.slice(0, r + 1).toLowerCase(); this._searchFieldsAbbreviation[a];) r++, (a = i.slice(0, r + 1).toLowerCase());
    ...
    (FamilyTree.searchUI.prototype.__search = function () {
        this.lastSearch = FamilyTree._search.search(this.obj.config.nodes, this.input.value, this._searchFields, this._searchFields, this.obj.config.searchDisplayField, this.obj.config.searchFieldsWeight, this._searchFieldsAbbreviation);
    }),
    (FamilyTree.searchUI.prototype._search = function () {
        var e,
            t = this;
        if (((this._searchAfterEnterPress = !1), this.input.value == FamilyTree.SEARCH_HELP_SYMBOL)) e = this.helpView();
        else {
            this.__search();
                ...
                for (var e = "", r = 0; r < t.lastSearch.length && !(r >= FamilyTree.SEARCH_RESULT_LIMIT); r++) {
                    ...
                    t.obj.config.searchDisplayField == a.__searchField
                        ...
                        : t.obj.config.searchDisplayField
                            ? ((o = a[t.obj.config.searchDisplayField]), FamilyTree.isNEU(o) && (o = ""), (s = a.__searchMarks))
                            : (o = a.__searchMarks),
                ...
                if (this.hasAttribute("data-search-item-id")) {
                    ...
                    if (t.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
                        if (!1 !== FamilyTree.events.publish("searchclick", [t.obj, e])) {
                            ...
                            i && i.removeAttribute("data-selected"), this.setAttribute("data-selected", "yes"), t.input.focus();
                        }
    ...
    (FamilyTree.searchUI.createItem = function (e, t, i, r) {
        return (
            ...
            `<tr data-search-item-id="${t}">\n                <td class="bft-search-image-td">\n                    ${(e = e
                ...
                : `<div class="bft-search-photo">${FamilyTree.icon.user(32, 32, "#aeaeae")}</div>`)}\n                </td>\n                <td class="bft-search-text-td">${i} <br/>${r}</td>\n            </tr>`
        );
    }),
    (FamilyTree.searchUI.prototype.hide = function () {
        this._searchAfterEnterPress && ((this._searchAfterEnterPress = !1), this.obj.draw()),
            ...
            this.input && ((this.input.value = ""), document.activeElement == this.input && this.input.blur(), document.activeElement == this.xBtn && FamilyTree.input.blurHandler(this.input));
    }),
    void 0 === FamilyTree && (FamilyTree = {}),
        ...
        FamilyTree.state._get(this.config.state, t, i, function (d) {
            (s.state = d),
                ...
                a != FamilyTree.action.init || !s.state || (n && n.method && "fit" == n.method)
                    ...
                    : ((s.viewBox = s.state.vb), (s.vbIsInitializedFromState = !0), Array.isArray(s.state.roots) && (s.config.roots = s.state.roots));
            var c = s.maxX,
                m = s.maxY,
                p = s.minX,
                h = s.minY,
            ...
            if (e) {
                ...
                a != FamilyTree.action.exporting && ((s.maxX = c), (s.maxY = m), (s.minX = p), (s.minY = h), (s.roots = u), (s.nodes = y), (s.visibleNodeIds = g.visibleNodeIds)),
                ...
                (s.oldNodes = y || null),
                    s._read(function (e) {
                        ...
                        (r.notif = e.limit),
                            ...
                            ((s.maxX = c), (s.maxY = m), (s.minX = p), (s.minY = h), (s.roots = u), (s.nodes = y), (s.visibleNodeIds = r.visibleNodeIds), (s.bordersByRootIdAndLevel = f), (s.rootList = e.rootList)),
                            l(r);
                    }, o);
        });
    }),
        ...
        null == l && (l = FamilyTree.local),
            l._setPositions(
                ...
                function (t) {
                    ...
                    for (var o = { minX: null, minY: null, maxX: null, maxY: null }, s = {}, d = 0; d < n.length; d++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(n[d], n[d], o, 0, s, l, i.config.orientation);
                    e({ minX: o.minX, minY: o.minY, maxX: o.maxX, maxY: o.maxY, bordersByRootIdAndLevel: s, nodes: a, roots: n, rootList: r.rootList, limit: t, adjustify: l });
                },
                a
            );
    }),
    ...
    (FamilyTree.manager._setCollpasedProperty = function (e, t, i, r, a, n, l) {
        null == e.collapsed && t.collapse && t.collapse.allChildren ? (e.collapsed = !0) : null == e.collapsed && (e.collapsed = !1),
            ...
            a == FamilyTree.action.init && null != l
                ...
                : a == FamilyTree.action.init
                    ...
                    : a == FamilyTree.action.centerNode || a == FamilyTree.action.insert || a == FamilyTree.action.expand || a == FamilyTree.action.collapse
    ...
    (FamilyTree.manager._iterate = function (e, t, i, r, a, n, l, o, s, d, c, m) {
        ...
        if (
            ...
            if (t.parent && t.parent.children.length && t.parent.children[t.parent.children.length - 1] == t) {
                for (var h = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++) {
                    -1 == (g = t.parent.children[y]).tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("assistant") && 0 == g.children.length
                        ? h.push(g.id)
                        : -1 != g.tags.indexOf("assistant")
                            ? f++
                            : (-1 == g.tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner")) || u++;
                }
                ((FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > 1 && h.length == t.parent.children.length - f - u) || (!FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > 1)) && (o[t.pid] = h);
            }
        } else if (!t.isAssistant && 0 == t.childrenIds.length && t.parent && !o[t.pid]) {
            for (h = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++) {
                var g;
                -1 == (g = t.parent.children[y]).tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("assistant") && 0 == g.childrenIds.length
                    ? h.push(g.id)
                    : -1 != g.tags.indexOf("assistant")
                        ? f++
                        : (-1 == g.tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner")) || u++;
            }
            ((FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > 1 && h.length == t.parent.childrenIds.length - f - u) || (!FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > 1)) && (o[t.pid] = h);
        }
        ...
        r++;
        for (T = 0; T < t.children.length; T++) FamilyTree.manager._iterate(e, t.children[T], i, r, a, n, l, o, s, d, c, m);
    }),
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = i.nodes, d = [], c = 0; c < s.length; c++) {
            var m,
                p = s[c];
            (m = FamilyTree.STRING_TAGS ? (p.tags ? p.tags.split(",") : []) : Array.isArray(p.tags) ? p.tags.slice(0) : []), o.filterUI.addFilterTag(p) && m.unshift("filter");
            ...
            FamilyTree.isNEU(p.ppid) || (u.ppid = p.ppid), FamilyTree.isNEU(p.stpid) || (u.stpid = p.stpid), null != i.orderBy && (u.order = FamilyTree.manager._getOrderFieldValue(p, i.orderBy)), (e[p.id] = u), d.push(p.id);
        }
        null != i.orderBy &&
            d.sort(function (t, r) {
                var a = e[t].order,
                ...
                return "number" == typeof a || "number" == typeof n
                    ...
                    : "string" == typeof a || "string" == typeof n
                        ? (null == a && (a = ""), null == n && (n = ""), i.orderBy.desc ? n.localeCompare(a) : a.localeCompare(n))
                        : void 0;
            });
        for (c = 0; c < d.length; c++) {
            ...
            } else b ? (g && ((u.collapsed = g.collapsed), (u.min = g.min)), b.childrenIds.push(u.id)) : (g && ((u.collapsed = g.collapsed), (u.min = g.min)), t.push(u), l.push(u.id));
    ...
    (FamilyTree.manager._createNodes = function (e) {
        ...
        if ((FamilyTree.manager.__createNodes(o, s, t, r, a, n, d, e), null != t.roots)) {
            ...
            for (var c = 0; c < t.roots.length; c++) {
                ...
                if (m && r == FamilyTree.action.centerNode) {
                    for (var p = m; null != p.pid || null != p.stpid;) p = null == p.pid && null != p.stpid ? o[p.stpid] : o[p.pid];
                    for (var h = o[a.id]; (null != h.pid || null != h.stpid) && h != m;) h = null == h.pid && null != h.stpid ? o[h.stpid] : o[h.pid];
                    p == h && (m = p);
                }
                if (m) {
                    ...
                    if (!f) {
                        if (!FamilyTree.isNEU(m.pid)) (H = (b = o[m.pid]).childrenIds.indexOf(m.id)) > -1 && b.childrenIds.splice(H, 1);
                        s.push(m);
                    }
                }
            }
        ...
        if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
            for (c = 0; c < t.expand.nodes.length; c++) {
                ...
                for (!0 === t.expand.allChildren && FamilyTree.manager._addExpandedNodeIdsIterate(g, o, y); g;) y.push(g.id), null == g.pid && null != g.stpid ? ((g = o[g.stpid]).min = !1) : (g = o[g.pid]);
            }
            ...
            for (c = 0; c < T.length; c++) for (var b = o[(g = o[T[c]]).pid]; b;) y.push(b.id), null == b.pid && null != b.stpid ? ((b = o[b.stpid]).min = !1) : (b = o[b.pid]);
        ...
        } else if (r == FamilyTree.action.insert) for (g = o[a.insertedNodeId]; g;) y.push(g.id), null == g.pid && null != g.stpid ? ((g = o[g.stpid]).min = !1) : (g = o[g.pid]);
        var _ = [],
            w = {},
            k = [],
            S = {},
        ...
        if (r == FamilyTree.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
            for (c = 0; c < a.ids.length; c++) {
                if (a.expandIds.has(a.collapseIds[c])) console.error(`id ${a.collapseIds[c]} exist in both collapseIds and expandIds`);
        ...
        for (c = 0; c < C.length; c++) {
                    ...
                    : -1 != z.tags.indexOf("right-partner")
                        ...
                        : -1 != z.tags.indexOf("left-partner")
                            ...
                            : -1 == z.tags.indexOf("partner") || M % 2
                                ? -1 != z.tags.indexOf("partner") && M % 2
                                    ? ((z.isPartner = 2), (z.children = []), N.push(z.id), M++)
                                    : z.parentPartner
                                        ? (E[z.parentPartner.id] || (E[z.parentPartner.id] = []), E[z.parentPartner.id].push(z.id))
                                        : I.push(z.id)
                                : ((z.isPartner = 1), (z.children = []), A.push(z.id), M++);
            }
            g.children = [];
            var P = [];
            ...
            for (F = 0; F < D.length; F++) {
                (z = o[D[F]]).collapsed || ((z.parentPartner = z.parent), (z.parent = g), (z.isChildOfPartner = !0), g.children.push(z));
            }
            for (F = N.length - 1; F >= 0; F--) if (E[N[F]]) for (u = 0; u < E[N[F]].length; u++) g.children.push(o[E[N[F]][u]]), L++, -1 == B.indexOf(N[F]) && B.push(N[F]);
            for (F = 0; F < I.length; F++) {
                var z = o[I[F]];
                g.children.push(z);
            }
            for (F = 0; F < A.length; F++) if (E[A[F]]) for (u = 0; u < E[A[F]].length; u++) g.children.push(o[E[A[F]][u]]), U++, -1 == O.indexOf(A[F]) && O.push(A[F]);
            for (F = 0; F < P.length; F++) {
                (z = o[P[F]]).collapsed || ((z.parentPartner = z.parent), (z.parent = g), (z.isChildOfPartner = !0), g.children.push(z));
            }
            (g.partnerSeparation = Math.max(B.length, O.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation),
                I.length || !L || U
                    ? I.length || L || !U
                        ? I.length || 1 != L || 1 != U
                            ? I.length || L || U
            ...
            if ((ae = i[(g = o[k[c]]).lcn ? g.lcn : "base"]).layout == FamilyTree.normal || !S[g.pid])
                for (F = 0; F < g.subLevels; F++) {
                    ...
                    if ((FamilyTree.manager._initDinamicNode(j, g.lcn), (b = g.parent)))
                        (H = b.children.indexOf(g)) > -1 && (b.children.splice(H, 1), b.children.splice(H, 0, j)), j.children.push(g), (j.parent = b), (g.parent = j), (o[j.id] = j);
                }
        }
        for (var $ in w) {
            (b = o[$]).hasAssistants = !0;
            ...
            for (F = b.children.length - 1; F >= 0; F--) {
                (z = b.children[F]).isAssistant
                    ...
                    : z.isPartner ||
                    (z.parent && S[z.parent.id] && j && z.parent.id != j.id && (Object.defineProperty(S, j.id, Object.getOwnPropertyDescriptor(S, z.parent.id)), delete S[z.parent.id]),
                        (z.parent = j),
            ...
            if (Y.length % 2) {
                ...
                FamilyTree.manager._initDinamicNode(X, q.lcn, !0), (q._m = X.id), (X.isAssistant = !0), (X.w = q.w), (X.h = q.h), (o[X.id] = X), Y.splice(Y.length - 1, 0, X.id);
            }
            var V = 1;
        ...
        var Q = !1;
        for (var ee in i) {
            if ((ae = i[ee]).layout == FamilyTree.mixed || ae.layout == FamilyTree.tree || ae.layout == FamilyTree.treeRightOffset || ae.layout == FamilyTree.treeLeftOffset) {
                Q = !0;
                break;
            }
        }
        ...
        if (Q || te) {
            ...
            for (var $ in S) {
                ...
                var ae;
                if ((ae = i[b.lcn ? b.lcn : "base"]).layout == FamilyTree.mixed || ae.layout == FamilyTree.tree || ae.layout == FamilyTree.treeRightOffset || ae.layout == FamilyTree.treeLeftOffset || te)
                    if (
                        ((ie.pnode = b),
                            (ie.layout = ae.layout),
                            (ie.childrenIds = S[$]),
                    ...
                    } else if (ie.layout == FamilyTree.tree || ie.layout == FamilyTree.treeRightOffset || ie.layout == FamilyTree.treeLeftOffset) {
                        ...
                        for (c = ie.childrenIds.length - 1; c >= 0; c--) {
                            for (z = o[ie.childrenIds[c]], F = 0; F < b.children.length; F++) b.children[F].id == z.id && b.children.splice(F, 1);
                            if (((z.parent = null), (z.layout = FamilyTree.tree), ie.layout == FamilyTree.treeRightOffset && oe.splice(0, 0, z.id), ie.layout == FamilyTree.treeLeftOffset || ie.layout == FamilyTree.treeRightOffset)) {
                                var se = new FamilyTree.node(z.id + "_mirror", re.id, [], "mirror");
                                FamilyTree.manager._initDinamicNode(se, z.lcn), (se.layout = FamilyTree.tree), (o[se.id] = se), oe.splice(0, 0, se.id);
                            }
                        ...
                        for (V = 1, F = oe.length - 1; F >= 0; F--)
                            if (F % 2 && F != oe.length - 1) {
                                ...
                                FamilyTree.manager._initDinamicNode(W, b.lcn), (W.layout = FamilyTree.tree), (o[W.id] = W), oe.splice(F, 0, W.id), V++;
        ...
        if (FamilyTree.VERTICAL_CHILDREN_ASSISTANT) for (c = 0; c < s.length; c++) FamilyTree.manager._verticalAssistantIterate(s[c], o);
    ...
    (FamilyTree.manager.getAllFields = function (e) {
        ...
        for (i = 0; i < e.nodes.length; i++) for (var r in e.nodes[i]) r !== FamilyTree.ID && r !== FamilyTree.TAGS && r !== FamilyTree.NODES && r !== FamilyTree.PID && r !== FamilyTree.STPID && (e.nodeBinding[r] || t.has(r) || t.push(r));
        return t;
    }),
    ...
    (FamilyTree.manager._getResponse = function (e, t, i, r, a, n, l, o, s, d, c, m, p, h, f) {
        ...
        if (c == FamilyTree.action.insert || c == FamilyTree.action.expand || c == FamilyTree.action.collapse || c == FamilyTree.action.update || c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
            var C = null;
            if (c == FamilyTree.action.insert && m && null != m.insertedNodeId && null != m.insertedNodeId) C = p[m.insertedNodeId];
            else if (c == FamilyTree.action.update && m && null != m.visId && null != m.visId) C = p[m.visId];
            else if ((c != FamilyTree.action.expand && c != FamilyTree.action.collapse && c != FamilyTree.action.maximize) || !m || null == m.id || null == m.id) {
                if (c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
                    switch (r.orientation) {
                        case FamilyTree.orientation.top:
                        case FamilyTree.orientation.top_left:
        ...
        return { animations: T, boundary: g, viewBox: s, visibleNodeIds: y, nodes: p, allFields: FamilyTree.manager.getAllFields(r) };
    }),
    (FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, l, o, s, d) {
        if (FamilyTree.manager._isVisible(e, i, r, a)) {
            l.push(e.id);
            var c = null;
            if ((a == FamilyTree.action.expand || a == FamilyTree.action.collapse || a == FamilyTree.action.maximize) && o && o[e.id] && "expandCollapseToLevel" == n.method) {
                ...
                if ((null != (f = o[e.id]).x && null != f.y && (c = { x: f.x, y: f.y }), (h = t[n.id]) && h == e)) (m = e.parent) && m.id == n.id && (c = { x: h.x + h.w / 2 - e.w / 2, y: h.y + h.h / 2 - e.h / 2 });
            } else if (a == FamilyTree.action.maximize && o && o[e.id]) {
                var h;
                if ((null != (f = o[e.id]).x && null != f.y && (c = { x: f.x, y: f.y }), (h = t[n.id]) && h == e)) (m = e.parent) && m.id == n.id && (c = { x: h.x + h.w / 2 - e.w / 2, y: h.y + h.h / 2 - e.h / 2 });
            } else if (a == FamilyTree.action.minimize && o && o[e.id]) {
                c = { x: (f = o[e.id]).x, y: f.y };
            } else if (a == FamilyTree.action.insert && n && n.insertedNodeId == e.id && e.parent) c = { x: e.parent.x, y: e.parent.y };
            else if ((a != FamilyTree.action.update && a != FamilyTree.action.insert) || !o)
                a !== FamilyTree.action.exporting && a !== FamilyTree.action.init && -1 == s.indexOf(e.id) && (d[0].push(e.id), d[1].push({ opacity: 0 }), d[2].push({ opacity: 1 }));
            else {
                var f, u;
            ...
            null != c && null != c.x && null != c.y && ((c.x == e.x && c.y == e.y) || (d[0].push(e.id), d[1].push({ transform: [1, 0, 0, 1, c.x, c.y] }), d[2].push({ transform: [1, 0, 0, 1, e.x, e.y] })));
        }
        for (var y = 0; y < e.stChildren.length; y++) FamilyTree.manager._iterate2(e.stChildren[y], t, i, r, a, n, l, o, s, d);
    ...
    (FamilyTree.manager._setMinMaxXYAdjustifyIterate = function (e, t, i, r, a, n, l) {
        ...
        for (var o = 0; o < e.stChildren.length; o++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(e.stChildren[o], e.stChildren[o], i, 0, a, n, l);
        e.isPartner ? (e.sl = r - 1) : (e.sl = r), null == a[t.id] && (a[t.id] = {}), null == a[t.id][e.sl] && (a[t.id][e.sl] = { minX: null, minY: null, maxX: null, maxY: null }), e.layout || FamilyTree._setMinMaxXY(e, a[t.id][e.sl]), r++;
        for (o = 0; o < e.children.length; o++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(e.children[o], t, i, r, a, n, l);
    }),
    (FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny = function (e, t, i, r, a, n) {
        ...
        var l = r.id;
        ((i == FamilyTree.action.minimize && t[l].parent) || (i == FamilyTree.action.maximize && t[l].parent)) && (l = t[l].pid);
        var o = t[l],
            s = a[l];
    ...
    (FamilyTree.manager._verticalAssistantIterate = function (e, t) {
        ...
        if (3 == e.children.length) FamilyTree.manager._verticalAssistantIterate(e.children[0], t), FamilyTree.manager._verticalAssistantIterate(e.children[2], t), FamilyTree.manager._verticalAssistantIterate(e.children[1], t);
        ...
        if (e.isAssistant && e.isSplit && e.children.length) {
            ...
            var l = { max: 0 },
                o = { max: 0 };
            FamilyTree.manager._verticalAssistantLevelCountIterate(r, 0, l), FamilyTree.manager._verticalAssistantLevelCountIterate(a, 0, o);
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = i.nodes, d = [], c = {}, m = {}, p = 0; p < s.length; p++) {
            var h,
                f = s[p];
            (h = FamilyTree.STRING_TAGS ? (f.tags ? f.tags.split(",") : []) : Array.isArray(f.tags) ? f.tags.slice(0) : []), o.filterUI.addFilterTag(f) && h.push("filter");
            ...
            (g.ftChildrenIds = []),
                ...
                FamilyTree.isNEU(g.stpid)
                    ? (FamilyTree.isNEU(g.mid) || (c[g.mid] || (c[g.mid] = []), c[g.mid].push(g.id)),
                        ...
                        FamilyTree.isNEU(g.mid) && FamilyTree.isNEU(g.fid) && FamilyTree.isNEU(g.stpid) && (d.has(g.id) || d.push(g.id)))
    ...
    (FamilyTree.manager._iterateSetRootIds = function (e, t, i, r, a, n) {
        ...
        if (l) {
            ...
            if (i[l.id]) for (o = 0; o < i[l.id].length; o++) FamilyTree.manager._iterateSetRootIds(i[l.id][o], t, i, r, a, n);
            if (r[l.id]) for (o = 0; o < r[l.id].length; o++) FamilyTree.manager._iterateSetRootIds(r[l.id][o], t, i, r, a, n);
        }
    }),
            ...
            if (g) {
                ...
                if (
                    ...
                    for (var b = 0; b < i[g.id].length; b++) {
                        var v = r[i[g.id][b]];
                        v && (FamilyTree.isNEU(v.fid) || FamilyTree.isNEU(v.mid)) && FamilyTree.manager._iterateFT(i[g.id][b], t, i, r, a, n, l, o, s);
                    }
    ...
    (FamilyTree.manager.getAllFields = function (e) {
        ...
        for (i = 0; i < e.nodes.length; i++)
            for (var r in e.nodes[i])
                r !== FamilyTree.ID && r !== FamilyTree.TAGS && r !== FamilyTree.NODES && r !== FamilyTree.PID && r !== FamilyTree.STPID && "mid" !== r && "fid" !== r && "pids" !== r && (e.nodeBinding[r] || t.has(r) || t.push(r));
        return t;
    }),
    ...
    (FamilyTree.templates.dot.node = '<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>'),
    ...
    (FamilyTree.templates.tommy.defs =
        "<style>                          \n                                        .{randId} .bft-edit-form-header, .{randId} .bft-img-button{\n                                            background-color: #aeaeae;\n                                        }\n                                        .{randId}.male .bft-edit-form-header, .{randId}.male .bft-img-button{\n                                            background-color: #039BE5;\n                                        }        \n                                        .{randId}.male div.bft-img-button:hover{\n                                            background-color: #F57C00;\n                                        }\n                                        .{randId}.female .bft-edit-form-header, .{randId}.female .bft-img-button{\n                                            background-color: #F57C00;\n                                        }        \n                                        .{randId}.female div.bft-img-button:hover{\n                                            background-color: #039BE5;\n                                        }\n                                    </style>"),
    (FamilyTree.templates.tommy.field_0 = "<text " + FamilyTree.attr.width + '="230" style="font-size: 18px;font-weight:bold;" fill="#ffffff" x="10" y="90" text-anchor="start">{val}</text>'),
    (FamilyTree.templates.tommy.field_1 = "<text " + FamilyTree.attr.width + '="150" style="font-size: 14px;" fill="#ffffff" x="10" y="65" text-anchor="start">{val}</text>'),
    ...
    (FamilyTree.templates.hugo.img_0 = '<use xlink:href="#hugo_img_0_stroke" /><image preserveAspectRatio="xMidYMid slice" clip-path="url(#hugo_img_0)" xlink:href="{val}"  x="90" y="-5"  width="70" height="70"></image>'),
    (FamilyTree.templates.hugo.field_0 = "<text " + FamilyTree.attr.width + '="230" style="font-size: 18px;font-weight:bold;" fill="#ffffff" x="125" y="85" text-anchor="middle">{val}</text>'),
    (FamilyTree.templates.hugo.field_1 = "<text " + FamilyTree.attr.width + '="230" style="font-size: 14px;" fill="#ffffff" x="125" y="105" text-anchor="middle">{val}</text>'),
    ...
    (FamilyTree.templates.hugo_male.node = '<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill=url(#hugo_grad_male) stroke="#aeaeae" rx="7" ry="7"></rect>'),
    (FamilyTree.templates.hugo_female = Object.assign({}, FamilyTree.templates.hugo)),
    (FamilyTree.templates.hugo_female.node = '<rect x="0" y="0" height="{h}" width="{w}" stroke-width="1" fill=url(#hugo_grad_female) stroke="#aeaeae" rx="7" ry="7"></rect>'),
    ...
    (FamilyTree.templates.split.node = '<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>'),
    ...
    (FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, l, o, s, d) {
            ...
            c.defs && (m = m.replaceAll("{randId}", FamilyTree.ui._defsIds[e.templateName])), null == l && (l = r.nodeBinding);
            var p = { node: e, data: t };
            for (var h in l) {
                var f,
                    u = l[h];
            ...
            var v = "";
            e.lcn && (v = 'lcn="' + e.lcn + '"');
            var F = FamilyTree.nodeOpenTag.replace("{lcn}", v).replace("{id}", e.id).replace("{class}", b).replace("{sl}", e.sl).replace("{level}", e.level).replace("{x}", T.x).replace("{y}", T.y),
                x = FamilyTree._getOpacity(i, e);
            return (m = (F = F.replace("{opacity}", x)) + (m += FamilyTree.ui.nodeBtns(r, e, o, c, d)) + FamilyTree.grCloseTag);
        },
                    ...
                    if (
                        ((o -= d.expandCollapseSize / 2),
                            ...
                            e.getCollapsedIds(t).length
                                ? ((n += FamilyTree.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", s)), (n += d.plus), (n += FamilyTree.grCloseTag))
                                : ((n += FamilyTree.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", s)), (n += d.minus), (n += FamilyTree.grCloseTag)),
        ...
        link: function (e, t, i, r, a, n) {
            ...
            var m = 0,
                ...
                f = void 0;
            if (e.hasPartners) {
                f = { ids: [], indexes: {}, ppnodes: {}, lastLeft: null, firstRight: null, maxSidePartnersWithChildren: 0, rightIds: [], leftIds: [], partnerChildrenSplitSeparation: t.config.partnerChildrenSplitSeparation };
                for (var u = 0; u < e.children.length; u++) {
                    (y = e.children[u]).parentPartner
                        ? ((f.ppnodes[y.id] = y.parentPartner),
                            f.ids.push(y.id),
                            1 == y.parentPartner.isPartner
                                ? (-1 == f.rightIds.indexOf(y.parentPartner.id) && f.rightIds.push(y.parentPartner.id), (f.indexes[y.id] = f.rightIds.indexOf(y.parentPartner.id)), f.firstRight || (f.firstRight = y))
                                : 2 == y.parentPartner.isPartner && (-1 == f.leftIds.indexOf(y.parentPartner.id) && f.leftIds.push(y.parentPartner.id), (f.indexes[y.id] = f.leftIds.indexOf(y.parentPartner.id)), (f.lastLeft = y)))
                ...
                (f.maxSidePartnersWithChildren = Math.max(f.leftIds.length, f.rightIds.length)),
                    (m = 0 == f.maxSidePartnersWithChildren ? t.config.minPartnerSeparation / 2 : t.config.minPartnerSeparation / 2 + f.partnerChildrenSplitSeparation * f.maxSidePartnersWithChildren + f.partnerChildrenSplitSeparation / 2);
            }
            for (u = 0; u < e.children.length; u++) {
                ...
                if (-1 != b.indexOf("{rounded}"))
                    ...
                    b =
                        -1 != b.indexOf("{edge}")
                            ? b.replace("{edge}", "M" + T.xa + "," + T.ya + " " + T.xb + "," + T.yb + " " + T.xc + "," + T.yc + " L" + T.xd + "," + T.yd)
                            : -1 != b.indexOf("{curve}")
                                ? b.replace("{curve}", "M" + T.xa + "," + T.ya + " C" + T.xb + "," + T.yb + " " + T.xc + "," + T.yc + " " + T.xd + "," + T.yd)
                                : b.replaceAll("{xa}", T.xa).replaceAll("{ya}", T.ya).replaceAll("{xb}", T.xb).replaceAll("{yb}", T.yb).replaceAll("{xc}", T.xc).replaceAll("{yc}", T.yc).replaceAll("{xd}", T.xd).replaceAll("{yd}", T.yd);
                d.push(
                ...
                for (var C in t.config.linkBinding) {
                    ...
                    if (A) {
                        var N = A[I];
                        (k.value = N), (k.element = s[C]), (k.name = I), !1 !== FamilyTree.events.publish("label", [t, k]) && (FamilyTree.isNEU(k.value) || FamilyTree.isNEU(k.element) || (S += k.element.replace("{val}", k.value)));
                    }
                }
        ...
        __linkPpBottomTop: function (e, t, i, r, a, n) {
            ...
            return (
                1 == n.isPartner
                    ? ((l = n.x - t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - ((e.rightIds.length - 1) * e.partnerChildrenSplitSeparation) / 2),
                        e.lastLeft && l < e.lastLeft.x + e.lastLeft.w / 2
                            ...
                            : l < i.x + i.w / 2
                                ...
                                : (r += (e.indexes[i.id] + 1) * a))
                    : 2 == n.isPartner &&
                    ((l = n.x + n.w + t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - ((e.leftIds.length - 1) * e.partnerChildrenSplitSeparation) / 2),
        ...
        __linkPpLeftRight: function (e, t, i, r, a, n) {
            ...
            return (
                1 == n.isPartner
                    ? ((l = n.y - t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - ((e.rightIds.length - 1) * e.partnerChildrenSplitSeparation) / 2),
                        e.lastLeft && l < e.lastLeft.y + e.lastLeft.h / 2
                            ...
                            : l < i.y + i.h / 2
                                ...
                                : (r += (e.indexes[i.id] + 1) * a))
                    : 2 == n.isPartner &&
                    ((l = n.y + n.h + t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - ((e.leftIds.length - 1) * e.partnerChildrenSplitSeparation) / 2),
    ...
    (FamilyTree.ui.nodeBtns = function (e, t, i, r, a) {
        var n = "";
        if (a._tree_menu_temp) !t.isSplit && i !== FamilyTree.action.exporting && r.nodeTreeMenuCloseButton && a._tree_menu_temp.id == t.id && (n += r.nodeTreeMenuCloseButton);
        else {
        ...
        if ((this.config.mouseScrool == FamilyTree.action.xScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
            ...
            !(function (e, i, r) {
                ...
                e.addEventListener(
                    ...
                    function (e) {
                        var r = 0;
                        if (t.config.mouseScrool == FamilyTree.action.xScroll) (r = e.deltaX || e.wheelDeltaX) || (r = e.deltaY || e.wheelDeltaY);
                        else if (t.config.mouseScrool == FamilyTree.action.scroll && !(r = e.shiftKey ? e.deltaY || e.wheelDeltaY : e.deltaX || e.wheelDeltaX)) return;
    ...
    (FamilyTree.xScrollUI.prototype.create = function (e) {
        if (this.config.showXScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.xScroll) {
            ...
            (this.innerBar.innerHTML = "&nbsp"),
                Object.assign(this.bar.style, { position: "absolute", left: 0, bottom: 0, width: e + "px", "overflow-x": "scroll", height: "20px" }),
    ...
    (FamilyTree.yScrollUI.prototype.addListener = function (e) {
        var t = this;
        if (this.config.mouseScrool == FamilyTree.action.yScroll || this.config.mouseScrool == FamilyTree.action.scroll) {
            var i = FamilyTree._getScrollSensitivity();
            !(function (e, i, r) {
                var a = !1;
                function n() {
                ...
                e.addEventListener(
                    ...
                    function (e) {
                        var r = 0;
                        if (t.config.mouseScrool == FamilyTree.action.yScroll) (r = e.deltaY || e.wheelDeltaY) || (r = e.deltaX || e.wheelDeltaX);
                        else if (t.config.mouseScrool == FamilyTree.action.scroll && !(r = e.shiftKey ? e.deltaX || e.wheelDeltaX : e.deltaY || e.wheelDeltaY)) return;
                        (r = -r), (r = Math.max(-1, Math.min(1, r))), (t.pos += -r * i);
    ...
    (FamilyTree.yScrollUI.prototype.create = function (e) {
        if (this.config.showYScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.yScroll) {
            ...
            this.bar && this.bar.parentNode.removeChild(this.bar),
                ...
                (this.innerBar = document.createElement("div")),
                (this.innerBar.innerHTML = "&nbsp"),
                Object.assign(this.bar.style, { position: "absolute", right: 0, bottom: 0, height: e + "px", "overflow-y": "scroll", width: "20px" }),
                this.element.appendChild(this.bar),
                this.bar.appendChild(this.innerBar),
                this.bar.addEventListener("scroll", function () {
                    if (this.ignore) this.ignore = !1;
    ...
    (FamilyTree.prototype.zoom = function (e, t, i, r) {
        var a = this.getViewBox().slice(0),
            ...
            l = a[2],
            o = a[3];
        !0 === e ? ((a[2] = a[2] / FamilyTree.SCALE_FACTOR), (a[3] = a[3] / FamilyTree.SCALE_FACTOR)) : !1 === e ? ((a[2] = a[2] * FamilyTree.SCALE_FACTOR), (a[3] = a[3] * FamilyTree.SCALE_FACTOR)) : ((a[2] = a[2] / e), (a[3] = a[3] / e)),
            t || (t = [50, 50]),
    ...
    (FamilyTree.pdfPrevUI.show = function (e, t) {
        ...
        (r.id = "bft-ppdf-wrapper"),
            Object.assign(r.style, { "overflow-y": "scroll", "z-index": 11, position: "absolute", top: 0, left: "285px", "background-color": "#eee", width: e.width() - 270 + "px", height: "100%" }),
            e.element.appendChild(r),
            (r.innerHTML = '<div id="bft-ppdf-content" style="width: 100%;margin-top:10px;margin-bottom:10px;opacity:0;"></div>');
        var a,
            n,
            l,
        ...
        (o.value = t.format),
            ...
            (m.value = t.header),
            (p.value = t.footer),
            FamilyTree.animate(e.element.querySelector("#bft-ppdf-btns"), { margin: [0, 0, 0, -250] }, { margin: [0, 0, 0, 0] }, 300, FamilyTree.anim.outSin, function () {
            ...
            o.addEventListener("change", function () {
                FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"), { opacity: 1 }, { opacity: 0 }, 300, FamilyTree.anim.inSin, function () {
                    (e.element.querySelector("#bft-ppdf-content").innerHTML = ""), (t.format = o.value), e.exportPDF(t, FamilyTree.pdfPrevUI._handler), FamilyTree.pdfPrevUI._showHide(o, s, d);
                });
            }),
            s.addEventListener("change", function () {
                FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"), { opacity: 1 }, { opacity: 0 }, 300, FamilyTree.anim.inSin, function () {
                    (e.element.querySelector("#bft-ppdf-content").innerHTML = ""), (t.landscape = "true" == s.value), e.exportPDF(t, FamilyTree.pdfPrevUI._handler), FamilyTree.pdfPrevUI._showHide(o, s, d);
                });
            }),
            d.addEventListener("change", function () {
                FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"), { opacity: 1 }, { opacity: 0 }, 300, FamilyTree.anim.inSin, function () {
                    (e.element.querySelector("#bft-ppdf-content").innerHTML = ""), (t.scale = d.value), e.exportPDF(t, FamilyTree.pdfPrevUI._handler), FamilyTree.pdfPrevUI._showHide(o, s, d);
                });
            }),
    ...
    (FamilyTree.pdfPrevUI._showHide = function (e, t, i) {
        "A4" == e.value || "A3" == e.value || "A2" == e.value || "A1" == e.value || "Letter" == e.value || "Legal" == e.value
    ...
    (FamilyTree.pdfPrevUI._handler = function (e, t, i) {
        ...
        o.classList.add(e.config.mode), (o.innerHTML = i.outerHTML), FamilyTree._browser().msie && (o.innerHTML = new XMLSerializer().serializeToString(i));
        for (var s = o.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++) {
            var m = document.createElement("iframe");
            Object.assign(m.style, { display: "block", margin: "10px auto", border: "1px solid #eeeeee", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" }),
                d.appendChild(m),
                s && s.style.backgroundColor ? (m.style.backgroundColor = s.style.backgroundColor) : (m.style.backgroundColor = "#fff");
            ...
            a[c].footer && (f = a[c].footer),
                ...
                a[c].html
                    ? p.write(FamilyTree._exportHtml(a[c].html, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode))
                    : (s.setAttribute("viewBox", a[c].vb), p.write(FamilyTree._exportHtml(o.innerHTML, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode)));
    ...
    (FamilyTree._exportHtml = function (e, t, i, r, a, n, l, o) {
        ...
        return (
            n && (c += '<div id="bft-header" style="width:' + r + "px;color:#757575;position:absolute;left:" + i.margin[3] + 'px;top:0;">' + n + "</div>"),
            (c += e),
            l && (c += '<div id="bft-footer" style="width:' + r + "px;color:#757575;position:absolute;left:" + i.margin[3] + 'px;bottom:0;">' + l + "</div>"),
            (c += "</div>"),
            (c += "</body></html>")
        );
    }),
        ...
        for (var i, r, a, n, l, o = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (c && -1 != t.res.visibleNodeIds.indexOf(c.id) && m && -1 != t.res.visibleNodeIds.indexOf(m.id)) {
                ...
                switch (this.config.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                        T <= b ? ((x = 1), (y.x = T + c.w / 10), (g.x = b - m.w / 10)) : ((x = -1), (y.x = T - c.w / 10), (g.x = b + m.w / 10)),
                            h == u ? ((x = 1), (y.y = h), (g.y = u)) : h > u ? ((y.y = h), (g.y = u + m.h)) : ((y.y = h + c.h), (g.y = u));
                        break;
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
                        T <= b ? ((x = -1), (y.x = T + c.w / 10), (g.x = b + m.w / 10)) : ((x = 1), (y.x = T - c.w / 10), (g.x = b + m.w / 10)),
                            h == u ? ((x = -1), (y.y = h + c.h), (g.y = u + m.h)) : h > u ? ((y.y = h), (g.y = u + m.h)) : ((y.y = h + c.h), (g.y = u));
                        break;
                    case FamilyTree.orientation.left:
                    case FamilyTree.orientation.left_top:
                        v <= F ? ((x = -1), (y.y = v + c.h / 5), (g.y = F + m.h / 5)) : ((x = 1), (y.y = v - c.h / 5), (g.y = F + m.h / 5)),
                            p == f ? ((x = -1), (y.x = p), (g.x = f)) : p > f ? ((y.x = p), (g.x = f + m.w)) : ((y.x = p + c.w), (g.x = f));
                        break;
                    case FamilyTree.orientation.right:
                    case FamilyTree.orientation.right_top:
                        v <= F ? ((x = 1), (y.y = v + c.h / 5), (g.y = F + m.h / 5)) : ((x = -1), (y.y = v - c.h / 5), (g.y = F + m.h / 5)),
                            p == f ? ((x = 1), (y.x = p + c.w), (g.x = f + m.w)) : p > f ? ((y.x = p), (g.x = f + m.w)) : ((y.x = p + c.w), (g.x = f));
                }
                var _ = I(y, g, x),
                    w = d.template;
                w || (w = "orange");
                var k = FamilyTree.clinkTemplates[w],
                    S = ((i = y), (a = _), (n = void 0), (l = void 0), (n = ((r = g).x - i.x) / 2 + i.x), (l = (r.y - i.y) / 2 + i.y), { x: (n - a.x) / 2 + a.x, y: (l - a.y) / 2 + a.y });
                d.label && (o += k.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", d.label));
                var C = "M" + y.x + "," + y.y + "C" + y.x + "," + y.y + " " + _.x + "," + _.y + " " + g.x + "," + g.y;
                (o +=
                    ("<g " + FamilyTree.attr.c_link_from + '="{from}" ' + FamilyTree.attr.c_link_to + '="{to}">').replace("{from}", c.id).replace("{to}", m.id) +
            ...
            function I(e, t, i) {
                ...
                return (n = (n / (Math.sqrt(r * r + a * a) * i)) * FamilyTree.CLINK_CURVE), { x: e.x + r / 2 - a * n, y: e.y + a / 2 + r * n };
            }
        }
        t.content += o;
    }),
    ...
    (FamilyTree.prototype._slinks = function (e, t) {
        ...
        function n(t, n, l) {
            ...
            var h = FamilyTree.t(t.templateName, t.min, r),
                f = p.levelSeparation;
            ((t.parent && t.parent.layout == FamilyTree.mixed) || (t.parent && t.parent.layout == FamilyTree.tree)) && (f = p.mixedHierarchyNodesSeparation);
            var u = { p: t.x + t.w / 2 + h.expandCollapseSize, q: t.y, r: t.x + t.w / 2 + h.expandCollapseSize, s: a.minY + f };
            if (t.sl == n.sl)
                ...
                for (var y = t; null == d;) {
                    var g = !1,
                        ...
                        b = T.leftNeighbor,
                        v = T.rightNeighbor;
                    if ((T.id == n.id ? (d = T) : FamilyTree._intersects(T, u, e.config) && ((u = FamilyTree._addPoint(T, s, e.config, u, c)), (g = !0)), T.id != n.id)) {
                        for (; b;) {
                            if (b.id == n.id) {
                                d = b;
                                break;
                            }
                            FamilyTree._intersects(b, u, e.config) && ((u = FamilyTree._addPoint(b, s, e.config, u, c)), (g = !0)), (b = b.leftNeighbor);
                        }
                        for (; v;) {
                            if (v.id == n.id) {
                                d = v;
                            ...
                            FamilyTree._intersects(v, u, e.config) && ((u = FamilyTree._addPoint(v, s, e.config, u, c)), (g = !0)), (v = v.rightNeighbor);
                        }
                    }
                    if (!g) {
                        var F = s[s.length - 1][0],
                            x = 0;
                        if (T.parent)
                            switch (((f = p.levelSeparation), (T.parent.layout != FamilyTree.mixed && T.parent.layout != FamilyTree.tree) || (f = p.mixedHierarchyNodesSeparation), p.orientation)) {
                                case FamilyTree.orientation.top:
                                case FamilyTree.orientation.top_left:
            ...
            l && ((L = n.id), (U = t.id)),
                (i +=
                    ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", L).replace("{to}", U) +
    ...
    FamilyTree.events.on("redraw", function (e, t) {
        if (e.config.miniMap && e.manager.action != FamilyTree.action.move) {
            (FamilyTree.miniMap._settings._scale = Math.min(FamilyTree.miniMap.width / (e.response.boundary.maxX - e.response.boundary.minX), FamilyTree.miniMap.height / (e.response.boundary.maxY - e.response.boundary.minY))),
                (FamilyTree.miniMap._settings._translateX =
                    -e.response.boundary.minX * FamilyTree.miniMap._settings._scale + (FamilyTree.miniMap.width - (e.response.boundary.maxX - e.response.boundary.minX) * FamilyTree.miniMap._settings._scale) / 2),
                (FamilyTree.miniMap._settings._translateY =
                    -e.response.boundary.minY * FamilyTree.miniMap._settings._scale + (FamilyTree.miniMap.height - (e.response.boundary.maxY - e.response.boundary.minY) * FamilyTree.miniMap._settings._scale) / 2);
            var i = e.getViewBox();
        ...
        !(function e(t, n) {
            if (Array.isArray(n)) for (var l = 0; l < n.length; l++) e(t, n[l]);
                ...
                for (l = 0; l < n.stChildrenIds.length; l++)
                    r++,
                        a.includes(n.id) ||
                        (1 == r ? (i.fillStyle = FamilyTree.miniMap.colors[0]) : 2 == r ? (i.fillStyle = FamilyTree.miniMap.colors[1]) : 3 == r && (i.fillStyle = FamilyTree.miniMap.colors[2]),
                            i.beginPath(),
    ...
    (FamilyTree.miniMap._drawRectSelectorCanvas = function (e, t) {
        ...
        var a = t[0],
            ...
            l = t[2],
            o = t[3];
        (r.lineWidth = 0.5 / FamilyTree.miniMap._settings._scale), (r.strokeStyle = FamilyTree.miniMap.focusStroke), (r.globalAlpha = 1), r.clearRect(a, n, l, o), r.strokeRect(a, n, l, o);
    }),
    (FamilyTree.miniMap._initCtx = function (e, t, i) {
        ...
        (t.width = t.width),
            ...
            (r.globalAlpha = i),
            1 != i && ((r.fillStyle = FamilyTree.miniMap.selectorBackgroundColor), r.fillRect(0, 0, FamilyTree.miniMap.width, FamilyTree.miniMap.height)),
    ...
    (FamilyTree.miniMap._init = function (e) {
        if (!e.element.querySelector('[data-id="mini-map"]')) {
            ...
            for (var a = ["top", "right", "left", "bottom"], n = 0; n < a.length; n++) {
                var l = a[n];
                FamilyTree.isNEU(FamilyTree.miniMap.position[l]) || ("padding" == FamilyTree.miniMap.position[l] ? (r.style[l] = e.config.padding + "px") : (r.style[l] = FamilyTree.miniMap.position[l] + "px"));
            }
            ...
            var o = document.createElement("div");
            (o.style.position = "relative"), (o.style.width = FamilyTree.miniMap.width + "px"), (o.style.height = FamilyTree.miniMap.height + "px"), o.appendChild(t), o.appendChild(i), r.appendChild(o), e.element.appendChild(r);
            var s = function (t, i) {
    ...
    (FamilyTree._search.addNodeToResult = function (e, t, i, r, a, n) {
        ...
        null != r && (FamilyTree.isNEU(l.__score) && (l.__score = r.__score), FamilyTree.isNEU(l.__searchField) && (l.__searchField = a), FamilyTree.isNEU(l.__searchMarks) && (l.__searchMarks = r.__searchMarks)), e.push(l);
    }),
    (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
        ...
        var b = t;
        for (h = n.length - 1; h >= 0; h--) b = (b = b.insert(n[h].start + n[h].length, "</mark>")).insert(n[h].start, "<mark>");
    ...
    (FamilyTree._search.searchIndexesOf = function (e, t) {
        ...
        if (!FamilyTree.isNEU(e))
            for (var r = 0; r < t.length; r++) {
                var a = t[r];
                if (!FamilyTree.isNEU(a)) for (var n = 0; (n = e.indexOf(a, n)) > -1;) i.push({ length: a.length, start: n, searchPhrase: a }), (n += a.length);
            }
        return (
            i.sort(function (e, t) {
    ...
    FamilyTree.events.on("redraw", function (e, t) {
        if (e.config.state) {
            ...
            !(function e(t) {
                ...
                FamilyTree.state._put(e.config.roots, e.width(), e.height(), e.response.viewBox, i, r, e.response.adjustify, e.config.state);
        }
    }),
    (FamilyTree.state = {}),
    (FamilyTree.state._buildStateNames = function (e) {
        return { paramScale: e + "-scale", paramX: e + "-x", paramY: e + "-y", paramExp: e + "-exp", paramMin: e + "-min", paramRoots: e + "-roots", paramAdjustify: e + "-adjustify" };
    }),
        ...
        if (o) {
            ...
            if (o.writeToUrlParams) {
                ...
                c.has(s.paramScale) ? c.set(s.paramScale, d.scale) : c.append(s.paramScale, d.scale),
                    ...
                    c.has(s.paramRoots) && Array.isArray(d.roots) ? c.set(s.paramRoots, d.roots.join("*")) : Array.isArray(d.roots) && c.append(s.paramRoots, d.roots.join("*")),
                    c.has(s.paramMin) ? c.set(s.paramMin, d.min.join("*")) : c.append(s.paramMin, d.min.join("*")),
                    c.has(s.paramAdjustify) ? c.set(s.paramAdjustify, d.adjustify.x + "*" + d.adjustify.y) : c.append(s.paramAdjustify, d.adjustify.x + "*" + d.adjustify.y),
    ...
    (FamilyTree.state._get = function (e, t, i, r) {
        if (e) {
            ...
            if (e.readFromLocalStorage) {
                var m;
                if (null != (l = FamilyTree.localStorage.getItem(e.name))) return (l = JSON.parse(l)), ((m = [])[0] = l.x), (m[1] = l.y), (m[2] = t / l.scale), (m[3] = i / l.scale), (l.vb = m), void r(l);
    ...
    (FamilyTree.prototype.magnify = function (e, t, i, r, a) {
        ...
        if (n || l) {
            ...
            if ((o && (null != o.timer && clearInterval(o.timer), null != o.timerBack && clearInterval(o.timerBack), l.setAttribute("transform", "matrix(" + o.transformStart.toString() + ")"), (FamilyTree._magnify[e] = null)), i))
    ...
    (FamilyTree.prototype._windowKeyDownHandler = function (e, t) {
        ...
        if (i) {
            ...
            if (!1 !== FamilyTree.events.publish("key-down", [this, n]) && a)
                ...
                } else if ("ArrowDown" == t.code) a.childrenIds.length && ((this._keyNavigationActiveNodeId = a.childrenIds[0]), this.center(a.childrenIds[0]));
        ...
        let result = (
            t.btn && (n = `<a href="#" bft-input-btn="" class="bft-link bft-link-bft-button">${t.btn}</a>`),
            {
                html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id
                    }">${FamilyTree._escapeGreaterLessSign(a.label)}</label>\n                        <input ${a.readOnlyAttribute} data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" maxlength="256" id="${a.id}" name="${a.id
                    }" type="text" value="${FamilyTree._escapeDoubleQuotes(a.value)}" autocomplete="off">\n                        ${n}\n                    </div>\n                </div>`,
                id: a.id,
                value: a.value,
            }
        );
    ...
    (FamilyTree.elements.checkbox = function (e, t, i, r) {
        ...
        return {
            html: `<div class="bft-form-field"  style="min-width: ${i};" >\n                        <label class="bft-checkbox" data-bft-input="" ${a.disabledAttribute
                }>\n                            <input ${n} ${l} data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" type="checkbox"><span class="bft-checkbox-checkmark" type="checkbox"></span>${FamilyTree._escapeGreaterLessSign(
                    a.label
                )}\n                        </label>\n                    </div>`,
            id: a.id,
            value: n,
    ...
    (FamilyTree.elements.date = function (e, t, i, r) {
        ...
        return a.doNotRender
            ...
            : {
                html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id
                    }" class="hasval">${FamilyTree._escapeGreaterLessSign(a.label)}</label>\n                        <input data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} maxlength="256" id="${a.id
                    }" name="${a.id}" type="date" value="${FamilyTree._escapeDoubleQuotes(a.value)}" autocomplete="off">\n                    </div>\n                </div>`,
                id: a.id,
                value: a.value,
            };
    }),
    ...
    (FamilyTree.input.validate = function (e) {
        ...
        return a && "" == t.value
            ? ((i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + a + "</span>"), t.classList.add("bft-validation-error"), !1)
            : n && !FamilyTree.input.validatePassword(t.value)
                ? ((i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + n + "</span>"), t.classList.add("bft-validation-error"), !1)
                : l && !FamilyTree.input.isValidEmail(t.value)
                    ? ((i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + l + "</span>"), t.classList.add("bft-validation-error"), !1)
                    : !(o && !FamilyTree.input.isValidEmails(t.value)) || ((i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + o + "</span>"), t.classList.add("bft-validation-error"), !1);
    }),
    ...
    (FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        if (n) m.push(n);
            ...
            var p = { id: "_ft_mother", templateName: "mother", _ft_method: "addParentNode", _ft_childId: e, _ft_type: "mid", _ft_data: { gender: "female" } };
            (c.mid = p.id), a ? ((a.pids = [p.id]), (p.pids = [a.id]), (p._ft_data.pids = [a.id])) : (p.pids = ["_ft_father"]), m.push(p);
        }
        if (a) m.push(a);
        else {
            var h = { id: "_ft_father", templateName: "father", _ft_method: "addParentNode", _ft_childId: e, _ft_type: "fid", _ft_data: { gender: "male" } };
            (c.fid = h.id), n ? ((n.pids = [h.id]), (h.pids = [n.id]), (h._ft_data.pids = [n.id])) : (h.pids = ["_ft_mother"]), m.push(h);
        }
        for (s = 0; s < l.length; s++) m.push(l[s]);
        c.pids || (c.pids = []);
        var f = { id: "_ft_partner", pids: [e], templateName: "partner", _ft_method: "addPartnerNode", _ft_data: { pids: [e] } };
        if (("male" == c.gender ? ((f.templateName = "wife"), (f._ft_data.gender = "female")) : "female" == c.gender && ((f.templateName = "husband"), (f._ft_data.gender = "male")), c.pids.push(f.id), m.push(f), c.pids))
            //for (s = 0; s < c.pids.length; s++) {
            for (s = 0; s < c.pids.length - 1; s++) {
                if ((m.push({ id: "_ft_child_group_" + s, mid: e, fid: c.pids[s], tags: ["children-group"] }), "_ft_partner" == c.pids[s])) {
                    var u = {
                        id: "_ft_son_" + s,
                    ...
                    m.push({ id: "_ft_son_" + s, stpid: "_ft_child_group_" + s, templateName: "son", _ft_method: "addChildNode", _ft_data: { mid: e, fid: c.pids[s], gender: "male" } }),
                        m.push({ id: "_ft_daughter_" + s, stpid: "_ft_child_group_" + s, templateName: "daughter", _ft_method: "addChildNode", _ft_data: { mid: e, fid: c.pids[s], gender: "female" } });
                for (var g = 0; g < o.length; g++) (o[g].mid != c.pids[s] && o[g].fid != c.pids[s]) || ((o[g].mid = void 0), (o[g].fid = void 0), (o[g].stpid = "_ft_child_group_" + s), m.push(o[g]));
            }
        for (g = 0; g < o.length; g++)
            if ((o[g].fid == c.id && FamilyTree.isNEU(o[g].mid)) || (o[g].mid == c.id && FamilyTree.isNEU(o[g].fid))) {
                var T = { id: "_ft_partner_for_single_child", pids: [e], templateName: "partner", _ft_method: "addPartnerAndParentNodes", _ft_childId: o[g].id, _ft_partnerData: { pids: [e] }, _ft_id: e };
                "male" == c.gender ? ((T.templateName = "wife"), (T._ft_partnerData.gender = "female")) : "female" == c.gender && ((T.templateName = "husband"), (T._ft_partnerData.gender = "male")),
                    c.pids.push(T.id),
                    m.push(T),
                    o[g].fid == c.id ? (o[g].mid = "_ft_partner_for_single_child") : o[g].mid == c.id && (o[g].fid = "_ft_partner_for_single_child"),
                    m.push(o[g]);
            }
                    ...
                    "addParentNode" == i._ft_method
                        ...
                        : "addChildAndPartnerNodes" == i._ft_method
                            ...
                            : "addPartnerAndParentNodes" == i._ft_method
                                ? e[i._ft_method](i._ft_id, i._ft_childId, i._ft_partnerData, null, !0)
    ...
    (FamilyTree.filterUI.prototype.addFilterTag = function (e) {
        ...
        if ((null !== this.filterBy || "object" != typeof this.instance.config.filterBy || Array.isArray(this.instance.config.filterBy) || (this.filterBy = JSON.parse(JSON.stringify(this.instance.config.filterBy))), null != this.filterBy))
    ...
    (FamilyTree.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            else if (Array.isArray(this.instance.config.filterBy)) for (t = 0; t < this.instance.config.filterBy.length; t++) e[this.instance.config.filterBy[t]] = {};
            else if ("object" == typeof this.instance.config.filterBy) for (var r in this.instance.config.filterBy) e[r] = {};
            for (var a in e) {
                var n = e[a];
            ...
            if (null != this.filterBy) for (var o in e) if (this.filterBy[o]) for (var s in e[o]) this.filterBy[o][s] && (e[o][s] = this.filterBy[o][s]);
            this.filterBy = e;
            var d = this,
            ...
            (c.innerHTML = `<div>${m}</div>`),
                c.addEventListener("click", function (e) {
                    if (e.target.hasAttribute("data-filter-close") || e.target.hasAttribute("data-filter-field")) {
                        for (var t = e.target.getAttribute("data-filter-field"), i = d.instance.element.querySelectorAll("[data-filter-menu]"), r = 0; r < i.length; r++) i[r].style.display = "none";
                                ...
                                p[r].addEventListener("change", function (e) {
                                    ...
                                    if (t) {
                                        ...
                                        if (e.target.hasAttribute("data-all")) {
                                            for (var r = e.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < r.length; a++)
                                                if (r[a] != e.target) for (var n in ((r[a].checked = e.target.checked), d.filterBy[i])) d.filterBy[i][n].checked = e.target.checked;
                                        } else null != d.filterBy[i][this.name] && (d.filterBy[i][this.name].checked = this.checked);
                                        d.instance.draw();
                                    }
                                });
                        }
