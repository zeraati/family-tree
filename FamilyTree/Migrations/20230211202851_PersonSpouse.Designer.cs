...
namespace FamilyTree.Migrations
{
    ...
    [Migration("20230211202851_PersonSpouse")]
    partial class PersonSpouse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyTree.Entity.PersonSpouse", b =>
                {
                    b.HasOne("FamilyTree.Entity.Person", "Person")
                        .WithOne("PersonSpouse")
                        .HasForeignKey("FamilyTree.Entity.PersonSpouse", "PersonId")
                        .IsRequired()
                        .HasConstraintName("FK_PersonSpouse_Person");

                    b.HasOne("FamilyTree.Entity.Person", "Spouse")
                        .WithMany("SpouseOfPersons")
